...
from detector.core.yolov4 import YOLO, decode, filter_boxes
import detector.core.utils as utils
from detector.core.config import cfg

flags.DEFINE_string('weights', './data/custom_final.weights', 'path to weights file')
flags.DEFINE_string('output', './checkpoints/custom-416', 'path to output')
